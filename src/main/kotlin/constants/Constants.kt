...
val rolesMessageId = Snowflake.of(config.getLong("discord.rolesMessage.messageId"))
    ?: throw IllegalStateException("Something went wrong when retrieving the role selection message id. Environment variable ROLES_MESSAGE_ID might be missing")
val dailyUpdatesChannelId = Snowflake.of(config.getLong("discord.dailyUpdatesChannelId"))
    ?: throw IllegalStateException("Something went wrong when retrieving the daily updates channel id. Environment variable DAILY_UPDATES_CHANNEL_ID might be missing")